 ...
 * (e.g. swap in the real venue / real players) â€” see README.md.
 * -----------------------------------------------------------------------
 */
...
const VENUES = [
  {
    ...
    defaultPriceNote: "â‚¬38 / court (90 min) â†’ â‚¬11 / person incl. â‚¬1.50 balls"
  },
  {
    id: "venue-drop-shot",
    name: "Drop Shot Padel Club (placeholder)",
    address: "Carrer d'AragÃ³ 300, 08009 Barcelona",
    mapsUrl: "https://maps.google.com/?q=Carrer+d%27Arag%C3%B3+300+Barcelona",
    defaultPriceNote: "~â‚¬10-14 per person / hour, court split evenly"
  },
  {
    ...
    defaultPriceNote: "~â‚¬8-12 per person / hour"
  }
];
...
const PLAYERS = [
  { id: "p-joao",   name: "JoÃ£o Rawes Freitas", level: 3, active: true, nationality: "Portuguese", homeSchool: "ESADE", year: "2nd" },
...
// "this week" (see getCurrentSession in app.js â€” currently: the session
...
const SESSIONS = [
  {
    ...
    courtTotalPrice: 38,
    courts: 1,
    notes: "90 minutes (17:00-18:30). â‚¬38/court Ã· 4 + â‚¬1.50 balls = â‚¬11 per person. Bring a racket if you have one.",
    whatsappUrl: "",
    attendeeIds: []
  },
  {
  ...
  },
  {
    ...
    courtTotalPrice: 40,
    courts: 1,
    notes: "Small group â€” first session of the semester.",
    whatsappUrl: "",
    attendeeIds: []
  }
];
